...
const Home = () => {
  return <div className="min-h-screen">
    ...
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 bg-cover" style={{ backgroundImage: `url(${heroImage})`, backgroundPosition: "center 25%" }} />
    ...
    <section className="relative py-20 overflow-hidden bg-muted/30">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Accès rapides</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {[
            { icon: Newspaper, title: "Actualités", description: "Restez informé des dernières nouvelles de la copropriété", href: "/actualites", color: "from-orange-500/10 to-red-500/10" },
            { icon: Users, title: "Conseil Syndical", description: "Membres du conseil syndical et le syndic", href: "/syndic", color: "from-purple-500/10 to-pink-500/10" },
            { icon: KeyRound, title: "Badges Vigik", description: "", href: "/badges-vigik", color: "from-blue-500/10 to-cyan-500/10" },
            { icon: FileText, title: "Assemblées Générales", description: "Accédez aux comptes rendus des assemblées générales", href: "/ag", color: "from-green-500/10 to-emerald-500/10" },
            { icon: Sparkles, title: "Consultations", description: "Participez aux consultations et exprimez votre opinion", href: "/sondages", color: "from-indigo-500/10 to-blue-500/10" },
            { icon: Users, title: "Contactez-nous", description: "Contactez-nous directement", href: "/contact", color: "from-teal-500/10 to-green-500/10" },
          ].map((item, index) => (
            <Link key={index} to={item.href}>
              <Card className="h-full hover-lift border-border transition-all duration-300 hover:border-primary/50 animate-fade-in" style={{ animationDelay: `${index * 100}ms` }}>
